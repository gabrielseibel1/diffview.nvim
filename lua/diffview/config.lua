...
M.defaults = {
  ...
  keymaps = {
    ...
    view = {
      ...
      { { "n", "x" }, "<leader>cc", review_actions.comment_line,        { desc = "Review: add a comment on the current line / range" } },
      { "n",          "<leader>cC", review_actions.comment_file,        { desc = "Review: add a file-level comment on the current file" } },
      { "n",          "<leader>rl", review_actions.list_comments,       { desc = "Review: open the pending comments list" } },
      { "n",          "<leader>rs", review_actions.submit_review,       { desc = "Review: open the submit form" } },
      { "n",          "<leader>ry", review_actions.copy_review,         { desc = "Review: yank the review to clipboard" } },
    ...
    file_panel = {
      ...
      { "n", "<leader>R",      review_actions.toggle_reviewed,         { desc = "Review: toggle the reviewed checkbox on this file" } },
      { "n", "<leader>rl",     review_actions.list_comments,           { desc = "Review: open the pending comments list" } },
      { "n", "<leader>rs",     review_actions.submit_review,           { desc = "Review: open the submit form" } },
      { "n", "<leader>ry",     review_actions.copy_review,             { desc = "Review: yank the review to clipboard" } },
    },
