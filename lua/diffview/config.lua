...
M.defaults = {
  ...
  keymaps = {
    ...
    view = {
      ...
      { "n",          "<leader>je", review_actions.edit_comment_at_cursor, { desc = "Review: edit the comment on the current line" } },
      { "n",          "<leader>jd", review_actions.delete_comment_at_cursor,{ desc = "Review: delete the comment on the current line" } },
